<%-- 
    Document   : index
    Created on : Sep 5, 2017, 11:21:20 AM
    Author     : Sahil
--%>
...
<html>
    ...
    <body>
         ...
         <form action="goservlet.do" method="post">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center> <h4 class="modal-title" id="log">LOGIN</h4></center>
      </div>
...
<div class="row">
  <div class="col-md-2">      <div class="imgcontainer">
    <img src="images/trv.png" alt="Avatar" class="avatar">
  </div></div>
    <div class="col-md-4">
        <table id="tc">
                 ...
                 <tr><th><a href="booking.html">Submit</a></th><td><input type="reset" value="Reset" /></td></tr>
		...
		<div class="col-md-12">
			<div class="carousel slide" id="carousel-500128">
				...
				<div class="carousel-inner">
					...
					<div class="item">
                                            <img alt="looding" src="images\ex4.jpg" id="c1" />
